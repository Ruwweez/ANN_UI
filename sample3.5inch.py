...
class ENoseApp:
    ...
    def __init__(self, root):
        ...
        title_label.pack(pady=self.spx(6))
        ...
        ).pack(side="left", padx=(0, self.spx(6)))
    ...
    def redraw_graph(self):
        ...
        if graph_type == "Training State Plot (Sample)":
    ...
    def save_data(self):
        ...
        with open(filename, "w", newline="") as f:
            ...
            for i in range(len(self.time_data)):
                ...
                writer.writerow([
                    self.time_data[i],
                    self.format_elapsed(self.time_data[i]),
